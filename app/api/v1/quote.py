...
async def create_bookmark(quote_id: int, service: BookmarkService = Depends(get_bookmark_service), current_user: User = Depends(get_current_user)): # get_current_user 임시
    """
